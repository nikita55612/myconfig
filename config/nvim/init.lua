...
local function applyRecolTheme()
    ...
    local P = {
        black       = { "#0a1222", "#575656", "#303744" },
        red         = { "#ffa7c4", "#ffa7c4", "#ffb5cd" },
        green       = { "#85cc95", "#85cc95", "#98d4a5" },
        yellow      = { "#ffcb8b", "#ffcb8b", "#ffd39d" },
        blue        = { "#8dabe1", "#8dabe1", "#9fb8e6" },
        magenta     = { "#c792eb", "#c792eb", "#d0a3ee" },
        cyan        = { "#78ccf0", "#ffa7c4", "#8dd4f2" },
        white       = { "#ffffff", "#ffffff", "#ffffff" },
        orange      = { "#ffb9a8", "#ffb9a8", "#ffc4b5" },
        pink        = { "#ffd3e2", "#ffd3e2", "#ffdae6" },
        bg          = { "#0a111e", "#0e1729", "#132038", "#192848", "#223864" },
        fg          = { "#dde1e5", "#ced2d6", "#95989b", "#626466" },
        sel         = { "#2c3444", "#332d41" },
        cur         = {
            bg = "#ffa7c4",
            fg = "#ffffff",
